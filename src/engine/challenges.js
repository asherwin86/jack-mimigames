...
export const GOALS = {
  ...
  'penalty-kicks': [40, 80, 120],
  'goalkeeper': [50, 120, 250],
  'home-run-derby': [150, 350, 600],
  'curling': [15, 28, 40],
  'plinko': [120, 250, 400],
  'track-sprint': [150, 250, 350],
  'keepie-uppie': [10, 25, 50],
  'ski-jump': [150, 320, 480],
  'pool-break': [60, 120, 200],
  'slingshot-smash': [300, 800, 1500],
  'star-fighter': [1500, 5000, 12000],
  'missile-defence': [500, 1500, 3000],
  'turret-defence': [150, 500, 1200],
  'light-cycles': [30, 100, 250],
  'ghost-hunt': [200, 600, 1400],
  'jetpack-run': [300, 800, 1600],
  'sky-climb': [150, 400, 800],
  'tightrope': [30, 80, 120],
  'highway-rush': [500, 1500, 3000],
  'numbers-blast': [100, 350, 900],
  'tic-tac-toe': [8, 14, 20],
  'reversi': [1, 3, 6],
  'five-in-a-row': [1, 3, 6],
  'mancala': [1, 3, 6],
  'dots-and-boxes': [1, 3, 6],
  'blackjack': [110, 180, 300],
  'pig-dice': [1, 3, 5],
  'slot-machine': [250, 330, 500],
  'minesweeper': [100, 400, 800],
  'crate-push': [100, 300, 600],
  'tower-of-hanoi': [80, 200, 400],
  'peg-solitaire': [150, 250, 400],
  'knights-tour': [25, 45, 100],
  'eight-queens': [100, 200, 400],
  'water-sort': [100, 300, 500],
  'pipe-turn': [100, 300, 600],
  'gem-swap': [400, 1000, 2000],
  'odd-cube': [10, 20, 32],
  'math-dash': [120, 260, 420],
  'colour-clash': [15, 30, 45],
  'bowling-lane': [40, 65, 85],
  'mini-golf': [20, 15, 12],
  'archery-range': [35, 60, 80],
  'skee-ball': [100, 250, 400],
  'bubble-shooter': [200, 600, 1500],
  'bubble-pop': [250, 600, 1100],
  'dart-board': [150, 250, 350],
  'reaction-test': [450, 320, 250],
  'fishing-pond': [60, 150, 300],
  'crane-claw': [40, 100, 200],
  'tetra-drop': [500, 2000, 5000],
  'merge-2048': [500, 2500, 8000],
  'parking-panic': [2, 5, 9],
  'battleship': [55, 42, 34],
  'tank-battle': [300, 1000, 2500],
  'horde-survivor': [30, 100, 250],
  'rocket-lander': [100, 300, 700],
  'slalom-ski': [8, 20, 40],
  'air-hockey': [3, 7, 12],
